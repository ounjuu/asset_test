      ...
      <div className="px-[10px] mx-auto flex justify-between items-center h-[42px] w-full">
        ...
        <div className="flex">
          ...
          <nav className="hidden md:flex gap-10 font-medium items-center px-[42px]">
            ...
            <div className="flex justify-center items-center pt-[5px] w-[54px] h-[34px] cursor-pointer hover:opacity-80">
              <img
                src="/headerVIP.webp"
                alt="Logo"
        ...
        <div className="hidden md:block">
          <button className="px-4 py-2 rounded-md transition bg-white text-black text-sm font-bold">
            로그인
          </button>
        </div>
